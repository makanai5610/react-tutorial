...
export default class Nav extends React.Component {
    ...
    render() {
        ...
        const featuredClass = location.pathnamename === "/" ? "active" : "";
        const archivesClass = location.pathname.match(/^\/favorites/) ? "active" : "";
        const settingsClass = location.pathname.match(/^\/settins/) ? "active" : "";
                    ...
                    <div class={"navbar-collapse"} id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li class={settingsClass}>
                                <Link to="settings" onClick={this.toggleCollapse.bind(this)}>Setting</Link>
                            </li>
                        </ul>
                    </div>
                </div>
